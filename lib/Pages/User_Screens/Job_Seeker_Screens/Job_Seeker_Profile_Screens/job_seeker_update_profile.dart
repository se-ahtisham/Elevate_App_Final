...
class JobSeekerUpdateProfile extends StatefulWidget {
  const JobSeekerUpdateProfile({super.key});

  @override
  State<JobSeekerUpdateProfile> createState() => _JobSeekerUpdateProfileState();
}

class _JobSeekerUpdateProfileState extends State<JobSeekerUpdateProfile> {
