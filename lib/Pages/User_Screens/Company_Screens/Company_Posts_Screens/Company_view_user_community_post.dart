...
class CompanyViewUserCommunityPost extends StatefulWidget {
  const CompanyViewUserCommunityPost({super.key});

  @override
  State<CompanyViewUserCommunityPost> createState() =>
      _CompanyViewUserCommunityPostState();
}

class _CompanyViewUserCommunityPostState
    extends State<CompanyViewUserCommunityPost> {
